...
namespace ProjetoVendas2.Controllers
{
    public class PagamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PagamentoForma")] Pagamento pagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PagamentoForma")] Pagamento pagamento)
        {
            if (id != pagamento.Id)
            {
                return NotFound();
