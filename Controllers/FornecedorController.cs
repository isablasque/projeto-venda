...
namespace ProjetoVendas2.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FornecedorCnpj,FornecedorNome")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FornecedorCnpj,FornecedorNome")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
