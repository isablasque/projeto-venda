...
namespace ProjetoVendas2.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ClienteNome,ClienteTelefone,ClienteEmail")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ClienteNome,ClienteTelefone,ClienteEmail")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
