...
namespace ProjetoVendas2.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ProdutoNome,ProdutoPreco,ProdutoQuantidade,CategoriaId,FornecedorId")] Produto produto)
        {
            ...
            ViewData["CategoriaId"] = new SelectList(_context.Categoria, "Id", "CategoriaNome", produto.CategoriaId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProdutoNome,ProdutoPreco,ProdutoQuantidade,CategoriaId,FornecedorId")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
