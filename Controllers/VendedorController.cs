...
namespace ProjetoVendas2.Controllers
{
    public class VendedorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,VendedorNome")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VendedorNome")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
