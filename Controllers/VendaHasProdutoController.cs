...
namespace ProjetoVendas2.Controllers
{
    public class VendaHasProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,VendaId,ProdutoId,VendaHasQuantidade")] VendaHasProduto vendaHasProduto)
        {
            ...
            ViewData["ProdutoId"] = new SelectList(_context.Produto, "Id", "ProdutoNome", vendaHasProduto.ProdutoId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,VendaId,ProdutoId,VendaHasQuantidade")] VendaHasProduto vendaHasProduto)
        {
